function figure7() {
  ...
  //      { x: image_size + image_padding, y: 0, id: 'ig_weights', title: 'Integrated Gradients Attributions'},
    ...
    function select_new_image(row, i) {
        ...
        var interp_file = base_dir + '/Users/ewa_anna_szyszka/Desktop/blog/img1.png';
        var weights_file = base_dir + '/Users/ewa_anna_szyszka/Desktop/blog/img1.png';
        var eg_file = base_dir + '/Users/ewa_anna_szyszka/Desktop/blog/img1.png';
    ...
    function image_init(image_data) {
        ...
        images.enter()
            ...
            .attr('xlink:href', function(d) {
                if (d.id === 'display_image') {
                    return base_dir + '/Users/ewa_anna_szyszka/Desktop/blog/img1.png';
        ...
        indicator_images.enter()
            ...
            .attr('xlink:href', function(d) {
                return 'data_gen/data/' + d.id + '/Users/ewa_anna_szyszka/Desktop/blog/img1.png';
            })
            .attr('id', function(d) { return d.id; })
            .attr('x', function(d) { return d.x; })
            .attr('y', function(d) { return d.y; })
